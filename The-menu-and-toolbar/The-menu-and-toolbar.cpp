...
// The-menu-and-toolbar.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CThemenuandtoolbarApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CThemenuandtoolbarApp::OnAppAbout)
...
// создание CThemenuandtoolbarApp

CThemenuandtoolbarApp::CThemenuandtoolbarApp()
{
	...
	SetAppID(_T("The-menu-and-toolbar.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CThemenuandtoolbarApp

CThemenuandtoolbarApp theApp;


// инициализация CThemenuandtoolbarApp

BOOL CThemenuandtoolbarApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CThemenuandtoolbarDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CThemenuandtoolbarView));
	if (!pDocTemplate)
		return FALSE;
...
int CThemenuandtoolbarApp::ExitInstance()
{
...
// обработчики сообщений CThemenuandtoolbarApp
...
void CThemenuandtoolbarApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
