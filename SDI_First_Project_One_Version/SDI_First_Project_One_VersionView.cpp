...
// SDI_First_Project_One_VersionView.cpp : реализаци€ класса CSDI_First_Project_One_VersionView
//
...
// создание/уничтожение CSDI_First_Project_One_VersionView
...
// рисование CSDI_First_Project_One_VersionView
...
// печать CSDI_First_Project_One_VersionView
...
// диагностика CSDI_First_Project_One_VersionView
...
CSDI_First_Project_One_VersionDoc* CSDI_First_Project_One_VersionView::GetDocument() const // встроена неотлаженна€ верси€
{
...
// обработчики сообщений CSDI_First_Project_One_VersionView
