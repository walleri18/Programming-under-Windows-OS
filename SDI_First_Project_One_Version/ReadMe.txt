================================================================================
    БИБЛИОТЕКА MICROSOFT FOUNDATION CLASS. Обзор проекта SDI_First_Project_One_Version
===============================================================================

Это приложение SDI_First_Project_One_Version автоматически создано с помощью мастера приложений. Это приложение демонстрирует основные принципы использования классов Microsoft Foundation; оно также может использоваться в качестве основы для написания собственных приложений.

В этом файле представлена сводка содержимого всех файлов, входящих в состав приложения SDI_First_Project_One_Version.

SDI_First_Project_One_Version.vcxproj
...
SDI_First_Project_One_Version.vcxproj.filters
...
SDI_First_Project_One_Version.h
    Это основной файл заголовка приложения.
    Он содержит прочие заголовки, относящиеся к проекту (включая Resource.h), а также объявляет класс приложения CSDI_First_Project_One_VersionApp.

SDI_First_Project_One_Version.cpp
    Это основной исходный файл приложения, в котором содержится класс приложения CSDI_First_Project_One_VersionApp.

SDI_First_Project_One_Version.rc
...
res\SDI_First_Project_One_Version.ico
    Файл значка, используемый в качестве значка приложения. Этот значок включен с помощью основного файла ресурсов SDI_First_Project_One_Version.rc.

res\SDI_First_Project_One_Version.rc2
...
SDI_First_Project_One_Version.reg
...
res\Toolbar.bmp
    ...
    Начальная панель инструментов и строка состояния, созданные в классе CMainFrame. Измените этот точечный рисунок панели инструментов в редакторе ресурсов и обновите массив IDR_MAINFRAME TOOLBAR в файле SDI_First_Project_One_Version.rc, чтобы добавить кнопки панели инструментов.
/////////////////////////////////////////////////////////////////////////////

Мастер приложений создает один тип документов и одно представление:

SDI_First_Project_One_VersionDoc.h, SDI_First_Project_One_VersionDoc.cpp — документ
    Эти файлы содержат класс CSDI_First_Project_One_VersionDoc. Измените эти файлы, чтобы добавить особые данные документа и реализовать сохранение и загрузку файлов (посредством CSDI_First_Project_One_VersionDoc::Serialize).
    Документ будет содержать следующие строки:
        Расширение файла:      document
        Идентификатор типа файла:        SDIFirstProjectOneVersion.Document
        Заголовок главного фрейма:  SDI_First_Project_One_Version
        Имя типа документа:       SDI_First_Proje
        Имя фильтра:         SDI_First_Project_One_Version Files (*.document)
        Новое краткое имя файла: SDI_First_Proje
        Полное имя типа файла: SDI_First_Project_One_Version.Document

SDI_First_Project_One_VersionView.h, SDI_First_Project_One_VersionView.cpp — представление документа
    Эти файлы содержат класс CSDI_First_Project_One_VersionView.
    Объекты CSDI_First_Project_One_VersionView используются для просмотра объектов CSDI_First_Project_One_VersionDoc.
...
StdAfx.h, StdAfx.cpp
    Эти файлы используются для построения файла предкомпилированного заголовка (PCH) с именем SDI_First_Project_One_Version.pch и файла предкомпилированных типов с именем StdAfx.obj.
...
SDI_First_Project_One_Version.manifest
