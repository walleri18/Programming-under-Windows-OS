...
// Function_Calculate.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CFunction_CalculateApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CFunction_CalculateApp

CFunction_CalculateApp::CFunction_CalculateApp()
{
...
// Единственный объект CFunction_CalculateApp

CFunction_CalculateApp theApp;


// инициализация CFunction_CalculateApp

BOOL CFunction_CalculateApp::InitInstance()
{
