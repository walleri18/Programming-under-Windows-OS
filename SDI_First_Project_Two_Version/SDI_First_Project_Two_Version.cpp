...
// SDI_First_Project_Two_Version.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSDI_First_Project_Two_VersionApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CSDI_First_Project_Two_VersionApp::OnAppAbout)
...
// создание CSDI_First_Project_Two_VersionApp

CSDI_First_Project_Two_VersionApp::CSDI_First_Project_Two_VersionApp()
{
	...
	SetAppID(_T("SDI_First_Project_Two_Version.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CSDI_First_Project_Two_VersionApp

CSDI_First_Project_Two_VersionApp theApp;


// инициализация CSDI_First_Project_Two_VersionApp

BOOL CSDI_First_Project_Two_VersionApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CSDI_First_Project_Two_VersionDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CSDI_First_Project_Two_VersionView));
	if (!pDocTemplate)
		return FALSE;
...
int CSDI_First_Project_Two_VersionApp::ExitInstance()
{
...
// обработчики сообщений CSDI_First_Project_Two_VersionApp
...
void CSDI_First_Project_Two_VersionApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
