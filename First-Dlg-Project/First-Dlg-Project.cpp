...
// First-Dlg-Project.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CFirstDlgProjectApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CFirstDlgProjectApp

CFirstDlgProjectApp::CFirstDlgProjectApp()
{
...
// Единственный объект CFirstDlgProjectApp

CFirstDlgProjectApp theApp;


// инициализация CFirstDlgProjectApp

BOOL CFirstDlgProjectApp::InitInstance()
{
