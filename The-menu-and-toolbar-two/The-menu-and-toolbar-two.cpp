...
// The-menu-and-toolbar-two.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CThemenuandtoolbartwoApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CThemenuandtoolbartwoApp::OnAppAbout)
...
// создание CThemenuandtoolbartwoApp

CThemenuandtoolbartwoApp::CThemenuandtoolbartwoApp()
{
	...
	SetAppID(_T("The-menu-and-toolbar-two.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CThemenuandtoolbartwoApp

CThemenuandtoolbartwoApp theApp;


// инициализация CThemenuandtoolbartwoApp

BOOL CThemenuandtoolbartwoApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CThemenuandtoolbartwoDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CThemenuandtoolbartwoView));
	if (!pDocTemplate)
		return FALSE;
...
int CThemenuandtoolbartwoApp::ExitInstance()
{
...
// обработчики сообщений CThemenuandtoolbartwoApp
...
void CThemenuandtoolbartwoApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
